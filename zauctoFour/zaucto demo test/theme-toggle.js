  ...
  function addThemeToggleButton() {
    ...
    style.textContent = `
      ...
      .tt-track {
        ...
        border: 1px solid rgba(18,33,54,.18);
      ...
      .theme-toggle-btn:hover .tt-track {
        ...
        box-shadow: inset 0 2px 6px rgba(10,15,28,.18), 0 0 0 3px rgba(18,33,54,.12);
      }
      .tt-ico {
        position: absolute;
        top: 50%;
      ...
      body.dark-mode .left::before {
        background-image: linear-gradient(rgba(18,33,54,.1) 1px, transparent 1px), linear-gradient(90deg, rgba(18,33,54,.1) 1px, transparent 1px);
      }
      body.dark-mode .left::after {
        background: radial-gradient(circle, rgba(18,33,54,.2) 0%, transparent 70%);
      }
      body.dark-mode .left-logo {
        background: #1E293B;
        box-shadow: 0 2px 12px rgba(18,33,54,.2);
      }
      ...
      body.dark-mode .hero-grid {
        background-image: linear-gradient(rgba(18,33,54,.08) 1px, transparent 1px), linear-gradient(90deg, rgba(18,33,54,.08) 1px, transparent 1px) !important;
      }
      ...
      body.dark-mode .badge {
        background: rgba(18,33,54,.15);
        border-color: rgba(18,33,54,.3);
      }
